# 🗑️ Harmonogramy odbioru odpadów komunalnych – Świnoujście 2026

Kalendarze w formacie `.ics` (iCalendar) zawierające harmonogramy odbioru wszystkich rodzajów odpadów komunalnych w Świnoujściu w 2026 roku.

> **Źródło danych:** [Harmonogramy odbioru odpadów komunalnych w 2026 roku – swinoujscie.pl](https://www.swinoujscie.pl/artykul/114-12305-harmonogramy-odbioru-odpadow-komunalnych-w-2026-roku)

> ⚠️ **Uwaga:** Pliki zostały wygenerowane przy pomocy sztucznej inteligencji na podstawie oficjalnych harmonogramów opublikowanych przez Urząd Miasta Świnoujście i zostały **pobieżnie zweryfikowane przez człowieka**. W razie wątpliwości zawsze sprawdzaj aktualne informacje na stronie urzędu.

---

## 📋 Typy odpadów uwzględnione w kalendarzach

| Emoji | Rodzaj odpadu | Nieruchomości do 2 lokali | Nieruchomości pow. 2 lokali |
|-------|--------------|--------------------------|----------------------------|
| 🗑️ | Odpady zmieszane | Co tydzień (wg dnia dla ulicy) | 2–4× w tygodniu (wg adresu) |
| 🟤 | Bioodpady | Co 4 tyg. (I–II, XII) / co 2 tyg. (III–XI) | Co tydzień lub co 2 tyg. |
| 📦 | Papier | Co 6 tyg. (I–V, IX–XII) / co 4 tyg. (VI–VIII) | Co 2 tygodnie |
| 🟡 | Plastik i metal | Co 4 tyg. (I–III, X–XII) / co 2 tyg. (IV–IX) | Co 2 tygodnie |
| 🟢 | Szkło | Co 8 tyg. (I–III, X) / co 4 tyg. (IV–IX) | Co 2 tygodnie |
| 🛋️ | Gabaryty i RTV/AGD | 4× w roku (II, IV/V, VII, X) | Raz w miesiącu |
| 🎄 | Choinki | 2 terminy w styczniu/lutym | 2 terminy w styczniu/lutym |

---

## 🏡 Nieruchomości do 2 lokali

Domy jednorodzinne, bliźniaki i budynki z najwyżej dwoma lokalami mieszkalnymi. Obejmuje 8 rejonów.
...
## 🏢 Nieruchomości powyżej 2 lokali

Bloki, kamienice i budynki wielorodzinne z więcej niż dwoma lokalami mieszkalnymi. Obejmuje 6 rejonów.
...
## 📲 Jak zaimportować plik .ics?

| Aplikacja | Sposób importu |
|-----------|---------------|
| **Google Calendar** | [calendar.google.com](https://calendar.google.com) → Ustawienia ⚙️ → Importuj → wybierz plik `.ics` |
| **Apple Calendar (Mac)** | Menu Plik → Importuj → wybierz plik `.ics` |
| **Apple Calendar (iPhone/iPad)** | Wyślij plik na e-mail lub przez AirDrop → otwórz w aplikacji Kalendarz |
| **Outlook (desktop)** | Plik → Otwórz i eksportuj → Importuj/Eksportuj → Importuj plik iCalendar |
| **Outlook (web)** | [outlook.live.com](https://outlook.live.com) → Dodaj kalendarz → Prześlij z pliku |
| **Thunderbird** | Zakładka Kalendarz → Plik → Importuj → wybierz plik `.ics` |

Po jednorazowym imporcie wszystkie terminy pojawią się w Twoim kalendarzu — nie musisz nic aktualizować przez cały 2026 rok.

---

*Wygenerowano przy pomocy sztucznej inteligencji · Źródło: [swinoujscie.pl](https://www.swinoujscie.pl/artykul/114-12305-harmonogramy-odbioru-odpadow-komunalnych-w-2026-roku)*